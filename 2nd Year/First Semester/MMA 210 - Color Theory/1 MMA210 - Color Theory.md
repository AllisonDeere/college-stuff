# Seeing Through Design (Activity)
"Color doesn't exist without the eye—and the way we perceive color is shaped not just by biology, but by psychology, culture, and experience."

Based on what you’ve learned about how the eye works (rods, cones, the retina, the optic nerve) and how the brain interprets color, reflect on the following questions:

1. *How does understanding the anatomy of the eye how does this change the way you think about creating visuals or using color in your designs?*
